...
export const useDesignerElements = () =>
    useDesignerStore(useShallow((state) => state.elements));

export const useDesignerSelectedElement = () =>
    useDesignerStore(useShallow((state) => state.selectedElement));
...
export const useDesignerMoveActions = () =>
    useDesignerStore(
        useShallow((state) => ({
