 ...
 */
export function getDefaultAttributes<T extends ElementsType>(type: T): FieldAttributesMap[T] {
    return JSON.parse(JSON.stringify(defaultFieldAttributes[type])) as FieldAttributesMap[T]
}
 ...
 */
export function validateInstanceAttributes(instance: FormElementInstance): FormElementInstance {
